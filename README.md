...
<body>
    ...
    <br>
 <button id="btn" class="border-2 border-black-400  text-2xl mt-4 ml-30 bg-yellow py-3 px-6 mt-3 text-white transition-transform transform hover:scale-105 rounded-2xl "> Submit</button>     
