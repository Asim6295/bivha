...
<body>
    ...
    <br>
    <button type="button"  class="border-2 rounded-lg   text-2xl mt-4 ml-30 bg-green-600 py-3 px-6   text-white transition-transform transform hover:scale-105" id="btn" > Submit</button>     
