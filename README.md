...
<body>
    ...
    <br>
    <button id="btn" class="border-2   text-2xl mt-4 ml-30 bg-yellow-200 py-3 px-6 rounded-lg  text-black transition-transform transform hover:scale-105 "> Submit</button>     
